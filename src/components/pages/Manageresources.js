...
const Addresources = () => {
  const [cloudProviders, setCloudProviders] = useState([]); // New state for cloud providers
  ...
  const [popupType, setPopupType] = useState(''); // Popup type for conditional rendering
